...
#commands+=("./test_pair_lj_smoothed 2 lj_sample.inp")
#commands+=("./test_pair_lj_shifted_smoothed 2 lj_sample.inp")
...
commands+=("./test_coul_damped_smoothed 2 spce_sample.inp")
commands+=("./test_coul_shifted_smoothed 2 spce_sample.inp")
...
#commands+=("./test_respa 2 spce_sample.inp")
#commands+=("./test_phase_space_sharing 2 spce_sample.inp")
