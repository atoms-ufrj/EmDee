...
do i = 1, ntypes
  pair = EmDee_shifted_square_smoothed( EmDee_pair_lj_cut( epsilon(i), sigma(i) ), Rc - 1.0_rb )
...
expected = [-4180.0071205201639_rb, -617.08138531797272_rb, -3192.7954182277017_rb]
